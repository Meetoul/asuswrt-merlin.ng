...
export RT-AX58U_V2 += BUILD_NAME="RT-AX58U_V2" NVSIZE="128" DHDAP=n HND_WL=y DPSTA=n LACP=n WTFAST=n REPEATER=y IPV6SUPP=y \
		HTTPS=y ARM=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y MEDIASRV=y MODEM=y PARENTAL2=y ACCEL_PPTPD=y PRINTER=y WEBDAV=y \
		...
		COMFW=y AMAS_ETHDETECT=y IPV6S46=y NFS=Y WIREGUARD=y NTPD=y
